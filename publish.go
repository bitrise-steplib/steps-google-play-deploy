...
func createTrackRelease(whatsNewsDir string, versionCodes googleapi.Int64s, userFraction float64, updatePriority int64) (*androidpublisher.TrackRelease, error) {
